...
class components extends queries
{
    ...
    public function vc_rights($permission) : boolean
    {
    ...
    public function vc_art_switch($artifact) : string
    {
    ...
    public function vc_sl($item) : string
    {
    ...
    public function vc_select($name, $id, $array) : string
    {
    ...
    public function vc_selected($name, $id, $array, $selected) : string
    {
    ...
    public function vc_check_boolean($boolean) : string
    {
    ...
    public function vc_formname($name) : string
    {
    ...
    public function vc_save() : string
    {
    ...
    public function vc_form_end($formname) : string
    {
    ...
    public function vc_menuitem($link, $name) : string
    {
    ...
    public function vc_submenuitem($link, $name, $page) : string
    {
    ...
    public function vc_title($title) : string
    {
    ...
    public function vc_line($name, $field) : string
    {
    ...
    public function vc_table_line($content) : string
    {
    ...
    public function vc_button($name, $link) : string
    {
    ...
    public function vc_add_button($name, $link) : string
    {
    ...
    public function vc_delete_button($name, $link) : string
    {
    ...
    public function vc_yes_button($link) : string
    {
    ...
    public function vc_no_button($link) : string
    {
    ...
    public function vc_yes_no($yes_link, $no_link) : string
    {
    ...
    pulic function vc_small_title($title, $color) : string
    {
