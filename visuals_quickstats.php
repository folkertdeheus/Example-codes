 ...
 * The main (public) methods output the data directly, for shortening the calling of the method
 * 
 */
...
class visuals_quickstats extends visuals
{
    ...
    public function vi_edit_quickstat_modules() : void
    {
    ...
    public function vi_all_quickstat_calculations() : void
    {
    ...
    public function vi_add_quickstat_calculations() : void
    {
    ...
    public function vi_review_quickstat_calculations($name, $calculation) : void
    {
    ...
    private function quickstats_objects_check($value) : void
    {
    ...
    private function quickstats_loop_module($subject) : void
    {
    ...
    private function quickstats_loop_ship($subject) : void
    {
    ...
    private function quickstats_numeric($value) : void
    {
    ...
    private function quickstats_module_static($module_id, $item) : void
    {
    ...
    private function quickstats_module_variable($module_id, $item) : void
    {
    ...
    private function quickstats_ship_static($ship_id, $item) : void
    {
    ...
    private function quickstats_ship_variable($ship_id, $item) : void
    {
    ...
    private function quickstats_item_not_found($item) : void
    {
    ...
    private function quickstats_push_item($array, $item) : void
    {
    ...
    private function quickstats_rebuild_calculation() : void
    {
    ...
    private function quickstats_get_module($subject) : void
    {
    ...
    private function quickstats_get_module_item($varsta, $item) : void
    {
    ...
    private function quickstats_get_ship($subject) : void
    {
    ...
    private function quickstats_get_ship_item($varsta, $item) : void
    {
