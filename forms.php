...
/**
  * This file  contains the class that does the formhandling
  * The construct matches the send form and calls the appropriate method for the handling
  */
...
class forms extends queries
{
    ...
    private function add_users($name, $discord_id, $permissions_id) : void
    {
    ...
    private function edit_users($name, $discord_id, $permissions_id, $artifact_values_id) : void
    {
    ...
    private function add_artifact_levels($artifact_id, $level) : void
    {
    ...
    private function edit_artifact_levels($level) : void
    {
